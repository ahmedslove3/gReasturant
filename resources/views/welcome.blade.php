...
<body>
	...
	<div class="container">
		...
		<main>
			...
			<div class="tm-paging-links">
				<nav>
					<ul>
						...
						<li class="tm-paging-item"><a href="#" data-menu="{{strtolower(str_replace(' ','_',$menu_name->name))}}" class="tm-paging-link">{{$menu_name ->name}}</a></li>
			...
			<div class="row tm-gallery">
				...
				<!-- gallery page 1 -->
				<div id="tm-gallery-page-{{strtolower(str_replace(' ','_',$menu_name->name))}}" class="tm-gallery-page hidden">
	...
	<script>
		$(document).ready(function() {
			...
			$('.tm-paging-link').each((i, elem) => {
				if (i > 0) return;
				$(elem).addClass('active');
				var page = $(elem).data('menu');
				console.log(page);
				$('#tm-gallery-page-' + page).removeClass('hidden');
			});
		});
